...
class discord
{
    ...
    public function debug()
    {
        ...
        return [rand_cookie => $this->cookienum, email => $this->email, senha => $this->senha, success_login => $this->login_success, login_error_msg => $this->login_error_msg, token => $this->token, guilds => $this->guilds_count];
    }
}
